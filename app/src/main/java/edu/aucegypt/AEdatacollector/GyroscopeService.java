...
public class GyroscopeService extends IntentService implements SensorEventListener {
    ...
    private static GyroscopeService instance = null;
    ...
    public String getSensorID() {
        return getString(R.string.gyroscopeID);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        values.put(SensorDataContract.SensorData.COLUMN_NAME_VALUE, event.values[0] + "," + event.values[1] + "," + event.values[2]);
